...
It is not immediately clear how to achieve the latter modification complexity in $O(\log m)$ time, since $\lvert i - j \rvert \leq m$ is potentially larger than $O(\log m)$. %, and 
...
\begin{definition}[Fibered barcode]
	...
	The fibered barcode $\mathcal{B}(M)$ of a 2D persistence module $M$ is the map which sends each   line  $L \subset \mathbb{R}^https://www.overleaf.com/project/60edd57f71696a2859f4cf602$ with non-negative slope to the barcode $\mathcal{B}_L(M)$: 
