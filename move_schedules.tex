...
A performance comparison with other reduction-based persistent homology computations is given, wherein our approach is demonstrated to be an order of magnitude more efficient than existing approaches in a few common sparse dynamic settings, such as flock simulation and 2D persistence computation. We conclude with a discussion of situations where our strategy is most applicable and future directions for research.  
